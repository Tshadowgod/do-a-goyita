                      ...
                      <tr key={p.id} className="hover:bg-slate-50 transition-colors">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            {p.imageUrl ? (
                              <img src={p.imageUrl} alt={p.name} loading="lazy" className="h-10 w-10 rounded-lg object-cover border border-slate-200 flex-shrink-0" />
                            ) : (
                ...
                <Card key={p.id} className="p-4">
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      {p.imageUrl ? (
                        <img src={p.imageUrl} alt={p.name} loading="lazy" className="h-12 w-12 rounded-lg object-cover border border-slate-200 flex-shrink-0" />
                      ) : (
